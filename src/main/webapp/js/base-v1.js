 ...
 */
function login() {
    return location.href = "http://sso.yaoyao.com/user/login.html";
}
function regist() {
    return location.href = "http://sso.yaoyao.com/user/register.html";
}
...
function search(a) {
    var b = "http://search.yaoyao.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
